      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <center><span class="badge bg-success">用户专业人士</span></center>
					<h5 class="centered">${userInfo.u_name}</h5>
              	  
                  <li class="mt">
                      <a href="page/expert_index.jsp">
                  ...
                  <div class="col-md-12">
	 				...
	 				%>
                              ...
                              <tr>
                                  ...
                                  <td>
                                  <button class="btn btn-success btn-xs"  data-toggle="tooltip" data-placement="bottom" title="点击上传特征数据（未完成）" ><i class="fa fa-upload" aria-hidden="true"></i></button><!-- 需要一个上传图标 -->
                                     
                                      <button class="btn btn-primary btn-xs"  data-toggle="tooltip" data-placement="bottom" title="点击查看该模型" onClick="javascrtpt:window.location.href='../UtilServlet?modelId=<%=model_3d.getModel_id()%>'"><i class="fa fa-eye"></i> </button><!-- 需要一个查看图标 -->
