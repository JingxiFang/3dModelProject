  ...
  <section id="container" >
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href=" editor_index.jsp"><img src="assets/img/ui-sam.jpg" class="img-circle" width="60"></a></p>
              	  <center><span class="badge bg-success">用户编辑员</span></center>
					<h5 class="centered">${userInfo.u_name}</h5>
              	  
                  <li class="mt">
                      <a class="active" href="editor_index.jsp">
                  	...
                  	<a href="../SearchModel_3d">
                  		...
                  		<div class="col-md-2 col-sm-3 box0">
                  			<div class="box1">
					  			...
					  			<p>点击进行个人密码修改--可扩充为个人信息修改</p>
                  		</div>
                  		</a>
                  		<a href="#">
                  		<div class="col-md-2 col-sm-3 box0">
                  			<div class="box1">
					  			<i class="fa fa-3x fa-spinner fa-pulse fa-fw"></i>
					  			<h4>有待添加</h4>
                  			</div>
					  			<p>功能扩展日后添加.</p>
                  		</div>
                  ...
                  <div class="col-lg-3 ds">
                    <!--COMPLETED ACTIONS DONUTS CHART-->
                      ...
                      <div class="desc">
                      	...
                      	<div class="details">
                      		<p><muted>2 分钟</muted><br/>
                      		   <a href="#">张三</a> 上传了xxx.<br/>
                      		</p>
                      	</div>
                      </div>
                      <!-- Second Action -->
	...
	<script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            title: '欢迎访问三维模型图像管理系统！',
            // (string | mandatory) the text inside the notification
            text: '系统开发目标是设计一个上传、编辑、存储、下载三维模型或二维/三维图像系统。用户可以通过网页、PC或手机端完成操作.',
