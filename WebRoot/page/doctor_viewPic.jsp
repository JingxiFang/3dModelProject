                  ...
                  <div class="col-md-12">
	 				...
	 				%>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <button class="btn btn-primary btn-xs"  data-toggle="tooltip" data-placement="bottom" title="点击上传标记数据（未完成）" ><i class="fa fa-upload" aria-hidden="true"></i></button><!-- 需要一个上传图标 -->
                                      <button class="btn btn-success btn-xs"  data-toggle="tooltip" data-placement="bottom" title="点击标记该模型" onClick="javascrtpt:window.location.href='../UtilServlet?modelId=<%=model_3d.getModel_id()%>'"><i class="fa fa-tag" aria-hidden="true"></i></button><!-- 需要一个铅笔图标 -->
