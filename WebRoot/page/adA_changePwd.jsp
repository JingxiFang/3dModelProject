...
<html>
  <head>
    ...
    function commit(){
    	if(check()){
    		document.getElementById("updateform").action = "${pageContext.request.contextPath}/managerupdatepwd";
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a class="active" href="adA_changePwd.jsp" ><!-- adminupdatepwd?method=selectjsp&type=${manager.m_state} -->
